...
def jpg_one_crop():
    '''lists all channels that exist'''
    # open the saved file
    path = os.getcwd() + '/src_backend/base_tests/uploadphoto_test/test_one.jpg'
    img = Image.open(path)
    ...
    path = os.getcwd() + '/src_backend/base_tests/uploadphoto_test/test_one_cropped.jpg'
    cropped.save(path)
...
def jpg_two_crop():
    '''lists all channels that exist'''
    # open the saved file
    path = os.getcwd() + '/src_backend/base_tests/uploadphoto_test/test_two.jpg'
    img = Image.open(path)
    ...
    # save the file to test directory
    path = os.getcwd() + '/src_backend/base_tests/uploadphoto_test/test_two_cropped.jpg'
    cropped.save(path)
