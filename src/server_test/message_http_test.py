...
def test_message_react(url):
    ...
    response=send_request("POST",url,"message/react",{
        'token':user1.get("token"),
        "message_id":message_test_id,
        "react_id":1
    })
...
###################################################################
def test_message_pin_already_pin(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
...
###################################################################
def test_message_pin_wrong_token_id(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
...
###################################################################
def test_message_unpin_wrong_msg_id(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
...
###################################################################
def test_message_unpin_already_unpin(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
...
###################################################################
def test_message_unpin_wrong_token_id(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
...
###################################################################
def test_message_unpin_non_channel_member(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
...
###################################################################
def test_message_unpin_token_incorrect(url):
    '''
    test for message_send
    Test whether the msg can be sent normally
    when the sent time is in the past
