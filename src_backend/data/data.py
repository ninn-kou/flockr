...
def append_channels(channel):
    ...
    # write json to file
    with open('src_backend/data/channels.json', 'w') as file:
...
def insert_messages(message):
    ...
    # write json to file
    with open('src_backend/data/messages.json', 'w') as file:
...
def clear_profiles():
    ...
    files = glob.glob('src_backend/data/profiles/*')
    for f in files:
        os.remove(f)

def save_image(image, u_id):
    ''' save an image in the profiles directory'''
    path = os.getcwd() + '/src_backend/data/profiles/'
    if not os.path.exists(path):
        os.mkdir(path)
...
def get_profile_photo_path(u_id):
    ...
    path = os.getcwd() + '/src_backend/data/profiles/' + u_id + '.jpg'
...
def get_profile_photo_url(u_id):
    ...
    path = os.getcwd() + '/src_backend/data/profiles/' + str(u_id) + '.jpg'
...
def return_password_reset_email():
    ...
    with open('src_backend/data/password_reset_email.txt', 'r') as file:
        email = file.read()
        return email
